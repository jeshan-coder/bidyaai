...
/*
state related to chat
ChatMessage : responsible for storing message and image
ChatInitial : state while the ai model is ready but no message have been sent yet
ChatModelLoading : state while ai is being loaded into memory
ChatLoading : state when the model is processing a message
ChatLoaded : state when the model is ready and messages have been sent
 */
...
class ChatLoading extends ChatState {
  const ChatLoading({
    ...
    super.quizReady,
    super.generatedQuiz,
    required super.isContextAware,
    required super.languageCode,
    required super.readerReady,
  });
}
...
class ChatQuizReady extends ChatState {
  const ChatQuizReady({
    required super.messages,
    required super.generatedQuiz,
    required super.isContextAware,
    required super.languageCode,
    required super.readerReady,
  }) : super(quizReady: true);
